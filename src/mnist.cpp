...
void MNIST::create_shared_space()
{
    ...
    data_ = new Tensor(batch_size_, channels_, height_, width_);

    target_ = new Tensor(batch_size_, num_classes_);
